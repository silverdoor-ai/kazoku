...
/// @notice Contract for EIP-712 typed structured data hashing and signing - without using a constructor in order to be
/// fully compatible with the Hats Module Factory.
/// @author @st4rgard3n (https://github.com/St4rgarden/kazoku)
...
abstract contract HatsModuleEIP712 {
    /*´:°•.°+.*•´.*:˚.°*.˚•´.°:°•.°•.*•´.*:˚.°*.˚•´.°:°•.°+.*•´.*:*/
    ...
    function __init_EIP712() internal {
        require(!_innited, "EIP712: already initialized");
        _innited = true;
